"""CLI-интерфейс Day 8: история + измерение token usage."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Day 8 — работа с токенами")
    ...
    print(
        "Day 8 · Работа с токенами · /reset — очистить историю · /exit — выход\n"
