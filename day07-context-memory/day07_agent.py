"""CLI-интерфейс агента с сохранением истории между запусками (Day 7)."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Day 7 — агент с сохранением контекста")
    ...
    print(
        "Day 7 · Сохранение контекста · /reset — очистить историю · /exit — выход\n"
