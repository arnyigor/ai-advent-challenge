"""Local web view of the real Day 19 MCP pipeline."""
...
if __name__ == "__main__":
    server = create_server(int(os.environ.get("DAY19_WEB_PORT", "0")))
    print(f"Day 19: http://127.0.0.1:{server.server_port}/", flush=True)
    try:
